...
Peatio::Wallet.registry[:geth] = binancesmartchain::Wallet.new
Peatio::Wallet.registry[:parity] = binancesmartchain::Wallet.new
Peatio::Wallet.registry[:bnbchaind] = binancechain::Wallet.new
